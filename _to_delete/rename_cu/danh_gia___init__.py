"""Bộ đánh giá chất lượng hệ thống MOOC (danh_gia).

Hai phần đo hai thứ khác nhau, cố ý tách rời:

  PHẦN 1 — do_trich_xuat: model ĐỌC ảnh có đúng không (độ chính xác theo trường).
  PHẦN 2 — do_phe_duyet : model QUYẾT ĐỊNH có đúng không (precision/recall/F1).
...
Dùng:
    python -m danh_gia.chay mau     # tạo file nhãn rỗng
    python -m danh_gia.chay chay    # chạy và chấm điểm
"""
